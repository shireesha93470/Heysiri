...
public class Temp2 {
    ...
    public static int findParagraphStart(int start,String str)
    {
            ...
            {
                 if(str.charAt(start)== '<' && str.charAt(start+1)== 'h'  && str.charAt(start+2)== '1' && str.charAt(start+3)=='>')
                 {
    ...
    public static int findParagraphEnd(int end,String str)
    {
          ...
          {
                 if(str.charAt(end)== '<' && str.charAt(end+1)== '/'  && str.charAt(end+2)== 'h' && str.charAt(end+3)=='1'&& str.charAt(end+4)=='>')
                 {
